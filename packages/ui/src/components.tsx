...
const styles = StyleSheet.create({
  ...
  buttonText: { color: color.onPrimary, fontSize: type.body + 1, fontWeight: weight.bold },
  ...
  notice: { borderRadius: radius.md, paddingVertical: space.md, paddingHorizontal: space.lg, gap: space.xs },
  noticeText: { fontSize: type.body, lineHeight: 23, fontWeight: weight.medium },
