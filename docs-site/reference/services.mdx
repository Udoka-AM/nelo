...
**No durable nonces**, since it signs each redemption fresh. Multi-RPC failover is not written. Running it: [the relayer runbook](/operations/relay).

**51 tests**, against a fake network.
