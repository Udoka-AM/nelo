...
<Steps>
  <Step title="Run the app on a handset">
    ...
    It answers three questions at once: does the JS bundle, does StrongBox behave on real hardware, and does MWA find a wallet. `docs/HANDSET.md` in the repository is the ordered runbook — payer probe first, because it is self-driving and tests the deepest assumptions.
  </Step>
